...
- Accuracy and completeness always outrank brevity and formatting. Length limits shape the style, never the substance: include every material fact, figure, endpoint, condition, and qualifier the question requires, and answer every part of a multi-part question. Never drop or approximate a supported number to fit a shorter format.
